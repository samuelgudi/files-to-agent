...
- Redact tokens via getMessage() to handle httpx URL objects
...
- Install token-redaction filter in build_components

### Features

- Add TokenRedactionFilter for Telegram bot tokens
...
- Rewrite English-first with architecture diagram and clean structure
- Route vulnerability reports through GitHub Advisories
- Replace personal homelab examples with generic terms
